!function() {
    ...
    location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [ function() {
        ...
        function T() {
            t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {
                ...
                f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), u.addContact(n.User),
                u.addContacts(n.ContactList), d.initChatList(n.ChatSet), d.notifyMobile(f.getUserName(), g.StatusNotifyCode_INITED),
                v.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f),
                h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {
                    timing:{
                        initEnd:Date.now()
                    }
                });
        ...
        function N(e) {
            ...
            try {
                f.setSyncKey(e.SyncKey), f.updateUserInfo(e.Profile, function() {}), angular.forEach(e.DelContactList, function(t) {
                    d.deleteChatList(t.UserName), d.deleteChatMessage(t.UserName), u.deleteContact(t),
                    d.getCurrentUserName() == t.UserName && d.setCurrentUserName(""), console.log("DelContactList", e.DelContactList);
        ...
        window._appTiming = {}, r.go("chat"), e.CONF = g, t.isUnLogin = !window.MMCgi.isLogin,
        t.debug = !0, t.isShowReader = /qq\.com/gi.test(location.href), window.MMCgi.isLogin && (T(),
        h.browser.chrome && !MMDEV && (window.onbeforeunload = function(e) {
            ...
            console.log("newLoginPage", t), f.setSkey(t.SKey), f.setSid(t.Sid), f.setUin(t.Uin),
            f.setPassticket(t.Passticket), T();
        });
        var A, I;
        t.search = function() {
            ...
            switch (t.keyCode) {
              case g.KEYCODE_ARROW_UP:
                I && I.isOpen() && e.$broadcast("root:searchList:keyArrowUp"), t.preventDefault(),
                t.stopPropagation();
                break;

              case g.KEYCODE_ARROW_DOWN:
                I && I.isOpen() && e.$broadcast("root:searchList:keyArrowDown"), t.preventDefault(),
                t.stopPropagation();
                break;

              case g.KEYCODE_ENTER:
                I && I.isOpen() && e.$broadcast("root:searchList:keyEnter"), t.preventDefault(),
                t.stopPropagation();
            }
    ...
    angular.module("Controllers").controller("loginController", [ "$scope", "loginFactory", "utilFactory", "reportService", function(e, t, o, n) {
        $(".lang .lang-item").click(function(e) {
            ...
            o.log("login", r), e.uuid = r, e.qrcodeUrl = "https://login.weixin.qq.com/qrcode/" + r,
            e.code = 0, e.isScan = !1, e.isIPad = o.isIPad, e.isMacOS = o.isMacOS, e.isWindows = o.isWindows,
    ...
    angular.module("Controllers").controller("contentChatController", [ "$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y) {
        ...
        e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, e.$on("message:add:success", function(t, o) {
            ...
            m.open({
                ...
                controller:[ "$scope", function(o) {
                    o.MsgId = t, o.getMsgVideo = e.getMsgVideo, o.getMsgImg = e.getMsgImg, o.width = 800,
                    o.height = 600;
                } ]
            });
            ...
            for (var o, n, r = 0; r < e.imagesMessagesList.length; r++) if (o = e.imagesMessagesList[r],
            o.msg == t) {
                n = r;
                break;
            }
            ...
            for (var n, r, a, i = e.imagesMessagesList, c = !1, r = e.getMsgImg(t.MsgId), s = 0; s < i.length; s++) if (n = i[s],
            n.msg === t) {
                c = !0, n.url = r, a = s;
                break;
            }
            ...
            d - t.pageX < l && (C = t.pageX - l), p - t.pageY < f && (h = t.pageY - f), g.open({
                ...
                singletonId:"mmpop_profile",
                controller:[ "$scope", function(e) {
                    e.contact = a, e.MMDefaultRemark = MM.context("8d521cc"), e.addUserContent = MM.context("5a97440") + y.formatHTMLToSend(c.getUserInfo().NickName),
                    e.isShowSendBox = r || !1, e.chat = function(t) {
                        o.go("chat", {
                            userName:t
                        }), e.closeThisMmPop();
                        ...
                        e.editing = !1, e.contact.RemarkName = n, M({
                            method:"POST",
                        ...
                        s.verifyUser({
                            ...
                            e.closeThisMmPop(), m.openConfirm({
                                ...
                                templateUrl:"comfirmTips.html",
                                controller:[ "$scope", function(e) {
                                    e.title = MM.context("02d9819"), e.content = t.BaseResponse.ErrMsg || MM.context("f45a3d8"),
                                    e.callback = function() {
                                        e.closeThisDialog();
                                    };
                                } ]
        ...
        e.$watchCollection("chatContent", function(e) {
            ...
            $("#prerender").append(i), function(t, o, n, r) {
                setTimeout(function() {
                    function a() {
                        console.log("height", o.height()), l.height = c.height(), l.width = c.width(), n.MMImgStyle = l,
                        r(o.height()), t.$destroy(), o.remove();
                    }
                    function i(e) {
                        console.error(e), h.report(h.ReportType.imageLoadError, {
                            text:"chat content image preload fail",
                            src:this.src
                        }), l.height = 110, l.width = 110, n.MMImgStyle = l, t.$digest(), r(o.height()),
                        t.$destroy(), o.remove();
                    }
                    if (n.MsgType == u.MSGTYPE_EMOTICON || n.MsgType == u.MSGTYPE_IMAGE || n.MsgType == u.MSGTYPE_VIDEO) {
                        ...
                        n.ImgHeight) n.MsgType == u.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth + "px",
                        l.widht = c.width() + "px") :(l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l,
                        t.$digest(), r(o.height()), t.$destroy(), o.remove(); else if (s > 40 || 1 == c[0].complete && 0 !== c[0].naturalWidth && s > 0) r(o.height()),
                        t.$destroy(), o.remove(); else {
                            ...
                            if ("undefined" != typeof n.MMStatus && n.MMStatus != u.MSG_SEND_STATUS_SUCC) var f = e.$watch(function() {
                                ...
                                t == u.MSG_SEND_STATUS_SUCC && (c[0].onload = a, c[0].onerror = i, c[0].src = e.getMsgImg(n.MsgId, "slave"),
                                console.log("preload!!!!!!!!!!!!!!!!!! ", c[0].src), f());
    ...
    angular.module("Controllers").controller("chatSenderController", [ "$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
        ...
        function y() {
            var e, t;
            document.createRange ? (e = document.createRange(), e.selectNodeContents(D), e.collapse(!1),
            t = window.getSelection(), t.removeAllRanges(), t.addRange(e)) :document.selection && (e = document.body.createTextRange(),
            e.moveToElementText(D), e.collapse(!1), e.select());
        }
        function C(e) {
            var t, o, n = "";
            if (window.getSelection) t = window.getSelection(), t.rangeCount > 0 && (o = t.getRangeAt(0).cloneRange(),
            o.collapse(!0), o.setStart(D, 0), n = o.toString().slice(-e)); else if ((t = document.selection) && "Control" != t.type) {
                var r;
                o = t.createRange(), r = o.duplicate(), r.moveToElementText(D), r.setEndPoint("EndToStart", o),
                n = r.text.slice(-e);
            }
            return n;
        }
        function v(e, t) {
            ...
            } else n = t || !A ? document.selection.createRange() :A, e = e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;"),
            n.pasteHTML(e), n.select();
        }
        function w() {
            window.getSelection && (window.getSelection().getRangeAt(0).insertNode(I), k = I.offsetLeft,
            F = I.offsetTop - D.scrollTop, U.appendChild(I));
        }
        function S(t) {
            var o = r.open({
        ...
        function b(e) {
            D.innerHTML = t.editAreaCtn = e || "", D.focus(), p(), d.change("sender:active", !0),
            e && (y(), h());
        }
        function T(e) {
        ...
        $(D).on("input", function() {
            ...
            h();
        }), t.isDisabled = !t.userName, t.isMacOS = navigator.userAgent.toUpperCase().indexOf("MAC OS") > -1,
        t.editAreaCtn = "";
        var O;
            ...
            l.isSupport() ? l.capture({
                ok:function() {
                    ...
                    e = S(t), l.upload(JSON.stringify(t), function(t) {
                        ...
                        e.close()) :(console.log("capture upload success"), e.update(a.API_webwxpreview + "?fun=preview&mediaid=" + t.MediaId, t.MediaId));
                    });
                }
    ...
    angular.module("Controllers").controller("emojiController", [ "$rootScope", "$scope", "$timeout", "emojiFactory", "confFactory", "utilFactory", function(e, t, o, n, r, a) {
        o(function() {
            ...
            if ("A" == o.tagName) {
                ...
                switch (i) {
                  case "qq":
                    r = "[" + r + "]", a.browser.msie && a.browser.version < 9 || (r = n.getEmoticonByText(r)),
        ...
        t.pickConfig = {
            ...
            angular.forEach(t.selectedUsers, function(e) {
                ...
                e.BaseResponse && 0 != e.BaseResponse.Ret && -2013 != e.BaseResponse.Ret && d.openConfirm({
                    ...
                    controller:[ "$scope", function(t) {
                        t.title = MM.context("02d9819"), t.content = e.BaseResponse.ErrMsg || MM.context("f45a3d8"),
                        t.callback = function() {
                            t.closeThisDialog();
                        };
                    } ]
            ...
            return angular.forEach(t.selectedUsers, function(e, o) {
                ...
                e.BaseResponse && 0 == e.BaseResponse.Ret || -2013 == e.BaseResponse.Ret ? (n.go("chat", {
                    ...
                    templateUrl:"comfirmTips.html",
                    controller:[ "$scope", function(t) {
                        t.title = MM.context("02d9819"), t.content = e.BaseResponse.ErrMsg || MM.context("0d42740"),
                        t.callback = function() {
                            t.closeThisDialog();
                        };
                    } ]
    ...
    angular.module("Controllers").controller("contextMenuController", [ "$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function(e, t, o, n, r, a, i, c, s, l, u, f) {
                    ...
                    c.open({
                        ...
                        controller:[ "$scope", function(e) {
                            e.keypress = function(e) {
                                ...
                                e.length > 17 && (e = e.substring(0, 18)), e.length > 0 && e != n.getDisplayName() && s.modTopic(n.UserName, l.formatHTMLToSend(e)),
                                c.close();
                            }, e.cancel = function() {
                                c.close();
                            };
        ...
        function h(o, n, s, l, d) {
            function g(e) {
                var t = e && e.target;
                if (!t) return !1;
                if (t = angular.element(t), t.hasClass("js_message_bubble") || (t = t.parents(".js_message_bubble")),
                t = t.find(".js_message_plain"), t.length) {
            ...
            switch (+n) {
              case a.MSGTYPE_TEXT:
                ...
                s && parseInt(s)) return void (t.isShowContextMenu = !1);
                p = y ? y + ":" + m.MMActualContent :m.MMActualContent, p = p.replace(":", ": "),
                t.contextMenuList.push({
    ...
    angular.module("Controllers").controller("editAreaContactListController", [ "$scope", "confFactory", "utilFactory", "$timeout", function(e, t, o) {
        function n(t, n) {
            ...
            var r = c.offsetWidth;
            c.innerHTML = " ", e.insertContactToEditArea("<input type='text' un='" + t + "' value='" + n + "' style='width:" + r + "px' readonly='readonly' />"),
            e.closeThisMmPop();
        }
        function r(e) {
    ...
    angular.module("Controllers").controller("readMenuController", [ "$rootScope", "$scope", "subscribeMsgService", function(e, t, o) {
        t.copyCallback = function() {
            ...
            return console.log(o.current), console.log("fuck you copy link"), t.closeThisMmPop(),
    ...
    angular.module("Controllers").controller("transpondDialogController", [ "$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        function h(e, t) {
            ...
            o.ToUserName = t, o.FromUserName = p.getUserName(), o._h = void 0, o._offsetTop = void 0,
            o.MMSourceMsgId = e.MsgId, o.Content = o.MMActualContent, o = i.createMessage(o),
            i.appendMessage(o), i.sendMessage(o);
        }
    ...
    angular.module("Services").factory("chatFactory", [ "$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        ...
        var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, service = {
            ...
            createMessage:function(e) {
                switch (e.FromUserName || (e.FromUserName = accountFactory.getUserName()), e.ToUserName || (e.ToUserName = this.getCurrentUserName()),
                e.ClientMsgId = e.LocalID = e.MsgId = (utilFactory.now() + Math.random().toFixed(3)).replace(".", ""),
                e.CreateTime = Math.round(utilFactory.now() / 1e3), e.MMStatus = confFactory.MSG_SEND_STATUS_READY,
                e.MsgType) {
            ...
            _postMessage:function(url, data, msg) {
                data.FromUserName = msg.FromUserName, data.ToUserName = msg.ToUserName, data.LocalID = msg.LocalID,
                data.ClientMsgId = msg.ClientMsgId, data = angular.extend(accountFactory.getBaseRequest(), {
                    Msg:data
                ...
                mmHttp({
                    ...
                    0 == e.BaseResponse.Ret ? (msg.MsgId = e.MsgID, _msgMap[msg.MsgId] = msg, _addedMsgIdsMap[msg.MsgId] = !0,
                    msg.MMStatus = confFactory.MSG_SEND_STATUS_SUCC, $rootScope.$broadcast("root:msgSend:success", msg)) :(reportService.report(reportService.ReportType.netError, {
            ...
            addChatList:function(e) {
                ...
                e && (angular.isArray(e) || (e = [ e ]), angular.forEach(e, function(e) {
                    ...
                    o = _chatList.indexOf(t), -1 == o) _chatList.unshift(t), utilFactory.isRoomContact(t) && contactFactory.addBatchgetChatroomContact(t); else {
            ...
            getChatList:function() {
                ...
                return _chatListInfos.length = 0, angular.forEach(_chatList, function(o) {
                    ...
                    n = e._getLastMessage(r.UserName), angular.extend(a, r, {
                        MMDigest:n.MMDigest || "",
            ...
            addChatMessage:function(e) {
                if (e) {
                    ...
                    _addedMsgIdsMap[e.MsgId] || (_addedMsgIdsMap[e.MsgId] = !0, _msgMap[e.MsgId] = e,
                    o.push(e), $rootScope.$broadcast("message:add:success", e), t.getChatList());
                }
            },
            getMsg:function(e) {
                return _msgMap[e];
            ...
            getChatMessage:function(e, t) {
                var o = this;
                return t && (_currentUserName = e, o.markMsgsRead(e)), _chatMessages[e] || (_chatMessages[e] = []),
                _chatMessages[e];
            },
            ...
            messageProcess:function(e) {
                ...
                e.MMPeerUserName = t._getMessagePeerUserName(e), e.MsgType == confFactory.MSGTYPE_STATUSNOTIFY) return void t._statusNotifyProcessor(e);
            ...
            _commonMsgProcess:function(e) {
                ...
                e.Content = e.Content || "", e.MMDigest = "", e.MMIsSend = e.FromUserName == accountFactory.getUserName() || "" == e.FromUserName,
                o = n.getChatMessage(e.MMPeerUserName), utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !0,
                ...
                t && (i = t.getDisplayName(e.MMPeerUserName), i && (e.MMDigest = i + ":")))) :(e.MMIsChatRoom = !1,
                r = e.Content), e.MMIsSend || e.MMUnread != _aoUndefined || e.MsgType == confFactory.MSGTYPE_SYS || (e.MMUnread = !0),
                e.LocalID || (e.ClientMsgId = e.LocalID = e.MsgId), r = emojiFactory.emoticonFormat(r),
                e.MMActualContent = r, e.MMActualSender = a || e.FromUserName, n._calcMsgDisplayTime(o[o.length - 1], e);
            },
            ...
            _locationMsgProcess:function(e) {
                ...
                t[2] ? (e.MMLocationDesc = t[1], e.MMLocationUrl = t[2]) :(e.MMLocationDesc = t[0],
                e.MMLocationUrl = t[1]), e.MMLocationUrl = e.Url || e.MMLocationUrl, e.MMDigest += e.MMLocationDesc;
            },
            ...
            _appUrlMsgProcess:function(e, t) {
                e.MsgType = confFactory.MSGTYPE_APP, e.AppMsgType = confFactory.APPMSGTYPE_URL,
                t = t || MM.context("e5b228c") + e.FileName;
                var o = utilFactory.htmlDecode(e.MMActualContent).replace(/<br\/>/g, "");
                o = utilFactory.encodeEmoji(o), o = utilFactory.xml2json(o), e.MMAppMsgDesc = utilFactory.decodeEmoji(o.appmsg.des),
                e.MMDigest += t, o.appmsg.mmreader && this._appReaderMsgProcess(e, o.appmsg.mmreader);
            },
            _appReaderMsgProcess:function(e, t) {
                e.MsgType = confFactory.MSGTYPE_APP, e.AppMsgType = confFactory.APPMSGTYPE_READER_TYPE,
                e.MMCategory = 1 == t.category.count ? [ t.category.item ] :t.category.item, angular.forEach(e.MMCategory, function(e) {
            ...
            _appAttachMsgProcess:function(e) {
                var t = utilFactory.htmlDecode(e.MMActualContent).replace(/<br\/>/g, "");
                t = utilFactory.encodeEmoji(t), t = utilFactory.xml2json(t), e.MMDigest += MM.context("6daeae3"),
                e.MMFileStatus = confFactory.MM_SEND_FILE_STATUS_SUCCESS, e.MMAppMsgFileExt = t.appmsg.appattach.fileext.toLowerCase(),
            ...
            _shareCardProcess:function(e) {
                ...
                for (var t in e.RecommendInfo) e.RecommendInfo[t] || delete e.RecommendInfo[t];
                var o = utilFactory.htmlDecode(e.MMActualContent).replace(/<br\/>/g, "");
                o = utilFactory.encodeEmoji(o), o = utilFactory.xml2json(o), e.MMUserName = o.alias || o.username,
                e.RecommendInfo.NickName = utilFactory.decodeEmoji(e.RecommendInfo.NickName), e.RecommendInfo.HeadImgUrl = utilFactory.getContactHeadImgUrl({
                    UserName:e.RecommendInfo.UserName,
                    Skey:accountFactory.getSkey(),
                    MsgId:e.MsgId
    ...
    angular.module("Services").factory("accountFactory", [ "$q", "confFactory", "utilFactory", function(e, t, o) {
        var n, r, a, i = {}, c = null, s = {
            ...
            updateUserInfo:function(e, o) {
                ...
                if (e && e.BitFlag == t.PROFILE_BITFLAG_CHANGE) {
                    var r = {};
                    e.HeadImgUpdateFlag && (r.HeadImgUrl = e.HeadImgUrl), e.NickName.Buff && (r.NickName = e.NickName.Buff),
                    n.setUserInfo(r), o && o();
                }
            },
        ...
        return l == t.MM_NOTIFY_OPEN ? f.openNotify() :f.closeNotify(), u == t.MM_SOUND_OPEN ? f.openSound() :f.closeSound(),
        f;
    } ]);
}(), !function() {
    "use strict";
    angular.module("Services").factory("confFactory", [ "$q", function() {
        ...
        e.indexOf("wx2.qq.com") > -1 ? (t = "weixin.qq.com", o = "file2.wx.qq.com", n = "webpush2.weixin.qq.com") :e.indexOf("qq.com") > -1 ? (t = "weixin.qq.com",
        o = "file.wx.qq.com", n = "webpush.weixin.qq.com") :e.indexOf("web1.wechat.com") > -1 ? (t = "wechat.com",
        o = "file1.wechat.com", n = "webpush1.wechat.com") :e.indexOf("web2.wechat.com") > -1 ? (t = "wechat.com",
        o = "file2.wechat.com", n = "webpush2.wechat.com") :e.indexOf("wechat.com") > -1 ? (t = "wechat.com",
        o = "file.wechat.com", n = "webpush.wechat.com") :e.indexOf("web1.wechatapp.com") > -1 ? (t = "wechatapp.com",
        o = "file1.wechatapp.com", n = "webpush1.wechatapp.com") :(t = "wechatapp.com",
        o = "file.wechatapp.com", n = "webpush.wechatapp.com");
    ...
    angular.module("Services").factory("contactFactory", [ "$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function(e, t, o, n, r, a, i, c, s, l, u) {
        function f(e) {
            return e = angular.extend({
                ...
                PYInitial:"",
                PYQuanPin:""
            }, e, P), e.HeadImgUrl || (e.HeadImgUrl = r.API_webwxgeticon + "?seq=0&username=" + e.UserName + "&skey=" + a.getSkey()),
            e;
        }
        var d, g = window._contacts = {}, m = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], w = [], S = [], b = {}, T = {}, E = 0, N = [ "fmessage" ], P = {
            ...
            canSearch:function(e) {
                ...
                return c = t.toUpperCase().indexOf(e), s = o.toUpperCase().indexOf(e), c >= 0 || s >= 0 ? !0 :(c = n.toUpperCase().indexOf(e),
                s = r.toUpperCase().indexOf(e), c >= 0 || s >= 0 ? !0 :a.toUpperCase().indexOf(e) >= 0 ? !0 :i.toUpperCase().indexOf(e) >= 0 ? !0 :!1);
            },
            update:function(e) {
            ...
            specialContactHandler:function(e) {
                ...
                return t[e.UserName] && (e.NickName = t[e.UserName]), "fmessage" == e.UserName && (e.ContactFlag = 0),
                e;
            },
            addContact:function(e) {
                e && (e.isContact || (e = f(e), e.MMOrderSymbol = this.getContactOrderSymbol(e)),
                e.EncryChatRoomId && e.UserName && (e.MMFromBatchget = !0), e.RemarkName = e.RemarkName && i.transformSpanToImg(e.RemarkName),
                e.NickName = e.NickName && i.transformSpanToImg(e.NickName), e.isShieldUser() || !e.isContact() && !e.isRoomContact() ? this.addStrangerContact(e) :this.addFriendContact(e));
            },
            ...
            addBatchgetContact:function(e, t, r) {
                function i(e) {
                    ...
                    }), console.timeEnd("addContactsHandler"), d.addContacts(e.ContactList, !0), w = [],
                    !w.length && v.length > 0 && d.batchGetContact().then(i, s);
                }
                function s(e) {
                    var t = w;
                    w = [], E++, f.reject(e), 1 == t.length ? (console.log("batchGetContactError", t[0]),
            ...
            batchGetContact:function(e) {
                var n = o.defer(), i = 1;
                return S.length ? (i = S.length < 6 || E > 2 ? 1 :S.length < 40 ? 5 :10, w = S.splice(0, i),
            ...
            remoteSearch:function(e) {
                function n(e) {
                    for (var t, o, n = [], r = 0; r < e.length; r++) t = e[r].EncryUserName, o = g[t],
                    o && o.isContact() && !o.isBrandContact() && n.push(o);
                    return n;
                }
                var i = o.defer();
                return this.prevSearchCanceler && this.prevSearchCanceler.resolve(), this.prevSearchCanceler = o.defer(),
            ...
            pickContacts:function(e, t, o) {
                for (var n, r, a, i = [], c = this, s = t.all || {}, l = 0; l < e.length; l++) switch (n = e[l],
                a = t[n] || {}, a = $.extend({}, a, s), n) {
                  case "star":
            ...
            setTopContact:function(t, o) {
                ...
                e.$broadcast("contact:settop", n), u({
                    method:"POST",
    ...
    angular.module("Services").factory("loginFactory", [ "$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function(e, t, o, n, r, a, i, c) {
        var s = {
            ...
            timeoutDetect:function(e) {
                return e = +e, 1100 == e ? (window.onbeforeunload = null, this.loginout(0), !0) :1101 == e || 1102 == e ? (window.onbeforeunload = null,
    ...
    angular.module("Services").factory("utilFactory", [ "$q", "$rootScope", "confFactory", function(e, t, o) {
        function n(e, t, o, n) {
            var r;
            (r = l[e]) ? (r.intervalSum += o, n && n <= r.intervalSum && (setTimeout(t, 0),
            l[e].intervalSum = 0), clearTimeout(r.timer), r.timer = setTimeout(function() {
        ...
        var u = {
            ...
            browser:function() {
                ...
                var n = {};
                return e.browser && (n[e.browser] = !0, n.version = e.version), n.chrome ? n.webkit = !0 :n.webkit && (n.safari = !0),
                n;
            }(),
            isSpUser:function(e) {
            ...
            form:function(e, t) {
                ...
                n.push("</form>"), o = angular.element(n.join(""))[0], document.body.appendChild(o),
                o.submit();
            },
            ...
            removeHtmlStrTag:function(e) {
                return e = e || "", e = this.encodeEmoji(e), e = this.htmlDecode(e), e = this.clearHtmlStr(e),
    ...
    angular.module("Services").factory("screenShotFactory", [ "confFactory", "reportService", function(e, t) {
        ...
        function i(o, r) {
            var i = n();
            i.StopUpload(), i.ClearHeaders(), i.ClearFormItems(), i && (i.URL = (MMDEV ? "http://wx.qq.com" :"http://" + location.hostname) + e.API_webwxpreview + "?fun=upload",
            i.AddHeader("Cookie", document.cookie), i.AddFormItem("msgimgrequest", 0, 0, o),
            i.AddFormItem("filename", 1, 4, a()), i.OnEvent = function(e, o) {
                switch (o) {
                  case 2:
                    break;
    ...
    angular.module("Services").factory("notificationFactory", [ "utilFactory", function(e) {
        function t(e, t) {
            ...
            window.external.msSiteModeActivate(), o = {
                ieVerification:p + 1
            }), o;
        }
        function o(e) {
        ...
        function c(e, n) {
            ...
            c = o(a), h.push(c), M.autoClose && a && !a.ieVerification && a.addEventListener && a.addEventListener("show", function() {
                var e = c;
                setTimeout(function() {
                    e.close();
                }, M.autoClose);
    ...
    angular.module("Services").factory("resourceService", [ "$timeout", "$http", "$q", "$window", function(e, t, o, n) {
        function r(t, o, n) {
            ...
            for (var r, i = o.priority ? c :s, u = l.push({
                ...
                combo:o.combo,
                result:{}
            }) - 1, f = 0; f < t.length; f++) r = t[f], r._cbKey = u, r._resultKey = r.key || r.url,
            i.push(r);
            a();
        }
        function a() {}
    ...
    angular.module("Services").factory("stateManageService", [ "$http", "$q", function() {
        ...
        var o = {
            ...
            change:function(n, a) {
                ...
                c && (i = c["false"] || c["true"] ? c[s] :"true" == s ? c :void 0), o[n] !== a && t(n, a),
                o[n] = a, e(i);
            },
            canDo:function(e) {
                return a[e]();
    ...
    angular.module("Services").factory("reportService", [ "$http", "$rootScope", "confFactory", "accountFactory", function(e, t, o, n) {
        function r() {
            var e, t = {};
            return t.appTiming = N, window.performance && (e = window.performance.timing) && (t.pageTiming = e),
            t;
        }
        function a(e) {
            e.needSend ? (p({
        ...
        function m(e, t) {
            ...
            return t.watchersCount += e.$$watchers && e.$$watchers.length, t.scopesCount += 1,
            t;
        }
        function p(e, t) {
    ...
    angular.module("Services").factory("mmHttp", [ "$http", "$q", "$timeout", function(e, t, o) {
        function n(n) {
            ...
            function s() {
                return M >= d || l.complete ? !1 :(m && (y.resolve(), y = t.defer(), u.timeout = y.promise),
                M++, r(n.method, n.args), !0);
            }
    ...
    angular.module("Services").factory("titleRemind", [ "$window", function(e) {
        function t(e, t) {
            ...
            var r, a;
            "undefined" != typeof n.hidden ? (r = "hidden", a = "visibilitychange") :"undefined" != typeof n.mozHidden ? (r = "mozHidden",
            ...
            a = "webkitvisibilitychange"), "undefined" == typeof n.addEventListener || "undefined" == typeof r ? ($(window).focus(function() {
                t();
    ...
    var e = angular.element, t = (angular.isDefined, (document.body || document.documentElement).style,
    this.defaults = {
        className:"",
        plain:!1,
        showClose:!0,
    ...
    this.$get = [ "$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", "$animate", function(a, i, c, s, l, u, f, d, g, m) {
        var p = a.find("body"), h = {
            ...
            performClosePop:function(e, t) {
                ...
                i && !i.closing && (i.closing = !0, e.unbind("click"), 1 === n && p.unbind("keydown"),
                u.$broadcast("root:mmpop:closing", o), m.leave(e, function() {
                    i && (u.$broadcast("root:mmpop:closed", o), a.unbind("click", i.closeThisMmPop),
                    i.$destroy());
                }), r[o] && (r[o].resolve({
                    id:o,
                    value:t,
            ...
            open:function(l) {
                ...
                d.$result = w = e('<div id="' + C + '" class="mmpop" tabindex="-1"></div>'), w.html(template),
                ...
                return S = y.container ? y.container :p, c(w)(v), m.enter(w, S), y.autoFoucs && w.focus(),
                y.controller && (angular.isString(y.controller) || angular.isArray(y.controller) || angular.isFunction(y.controller)) && g(y.controller, {
                    $scope:v,
                    $element:w
                }), y.className && w.addClass(y.className), y.top && w.css("top", y.top), y.left && w.css("left", y.left),
                ...
                n.bind("paste", function() {
                    ...
                    s && clearTimeout(s), s = setTimeout(function() {
                        ...
                        if (-1 != l && -1 != u) {
                            ...
                            if (M > y && (m = p.slice(M) + m, p = p.slice(0, M)), M = m.lastIndexOf("<"), y = m.lastIndexOf(">"),
                            M > y) {
                                var C = h.indexOf(">") + 1;
                            ...
                            S && (document.createRange ? (v = document.createRange(), v.setStartAfter(S), v.collapse(!1),
                            w = window.getSelection(), w.removeAllRanges(), w.addRange(v)) :document.selection && (v = document.body.createTextRange(),
                            v.moveToElementText(S), v.collapse(!1), v.select()), S.parentNode.removeChild(S)),
                            a.$setViewValue(p + _ + h), s = null;
                        }
                    }, 50);
                        ...
                        jQuery(r).jPlayer({
                            ready:function() {
                                jQuery(this).jPlayer("setMedia", {
                                    ...
                                    poster:a.poster
                                }), a.muted !== e && jQuery(this).jPlayer("mute"), a.loop !== e && f && (jQuery(this).jPlayer("play"),
                                c());
                            },
                            click:function() {
    ...
    return {
        ...
        link:function(n, r) {
            ...
            function c(e) {
                ...
                r.top = Math.round(y.top - o.y * (r.height - y.height)), r.left = Math.round(y.left - o.x * (r.width - y.width)),
                y = r, d.css(r);
            }
            function s(e) {
            ...
            function f() {
                ...
                t.onload = function() {
                    ...
                    1 > e && 1 > o ? c({
                        ...
                        scale:o
                    }) :d.css(y), angular.extend(E, y), m[0].src = t.src, n.isLoaded = !0, n.containerStyle = null,
                    n.$digest();
                }, t.onerror = function() {
            ...
            n.isLoaded = !1, n.rotateDeg = 0, n.isIE = !!(o.browser.msie && o.version < 10),
            n.actions = {
                next:function() {
        ...
        this.$get = [ "$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function(u, f, d, g, m, p, h, M, y) {
            ...
            var _ = {
                ...
                performCloseDialog:function(t, o) {
                    ...
                    1 === s && C.unbind("keydown"), t.hasClass("ngdialog-closing") || (s -= 1), p.$broadcast("ngDialog.closing", t),
                    a ? t.unbind(i).bind(i, function() {
                        t.scope().$destroy(), t.remove(), 0 === s && (C.removeClass("ngdialog-open"), _.resetBodyPadding()),
                        p.$broadcast("ngDialog.closed", t);
                    }).addClass("ngdialog-closing") :(t.scope().$destroy(), t.remove(), 0 === s && (C.removeClass("ngdialog-open"),
                    _.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)), l[r] && (l[r].resolve({
                        id:r,
                        value:o,
                        $dialog:t,
                        remainingDialogs:s
                ...
                open:function(a) {
                    ...
                    return g.when(c(w.template || w.templateUrl)).then(function(t) {
                        if (f.put(w.template || w.templateUrl, t), w.showClose && (t += '<div class="ngdialog-close"></div>'),
                        u.$result = b = o('<div id="ngdialog' + r + '" class="ngdialog"></div>'), b.html(w.overlay ? '<div class="ngdialog-overlay"></div><div class="ngdialog-content">' + t + "</div>" :'<div class="ngdialog-content">' + t + "</div>"),
                        ...
                        if (w.className && b.addClass(w.className), T = w.appendTo && e.isString(w.appendTo) ? e.element(document.querySelector(w.appendTo)) :C,
                        w.preCloseCallback) {
                            var c;
    ...
    function o(e, t, o, n, r) {
        ...
        for (var s = t; s < e.length; s++) if (a = e[s], i = c, c += a._h || (a._h = r(a)),
        o + c > n) return {
            index:s,
            total:i
        };
    ...
    function r(e, t, r, a) {
        ...
        c = o(e, i, f, d, a).index, c = c >= e.length ? e.length - 1 :c, s = n(e, 0, i, a),
    ...
    function a(e, t, o, n) {
        ...
        e.bottomHeight = i.bottomHeight, e.topHeight = i.topHeight, o.length = 0, a = n.slice(i.startIndex, i.endIndex + 1),
        [].push.apply(o, a), console.timeEnd("render");
    }
    function i(e) {
        if (!(e.length <= 0)) for (var t, o = 0, n = 0; n < e.length; n++) t = e[n], t._offsetTop = o,
        o += t._h;
    }
    function c(e, t, o) {
    ...
    function s(e, t, o) {
        ...
        for (var r, a = e.length, i = 0, c = 0; a > c; c++) r = e[c], r._h ? (i++, i == a && n(e)) :(console.log("pre", "callcalc"),
        t(r, function(t) {
            return function(o) {
    ...
    return {
        ...
        link:function(e, o, n) {
            var r = [], u = {
                ...
                size:0,
                visible:687
            }, f = n.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), d = f[2], g = (f[1],
            '<div ng-style="{height:topHeight}" class="top-placeholder"></div><div ng-repeat="' + n.mmRepeat + '">' + o.html() + '</div><div ng-style="{height:bottomHeight}" class="bottom-placeholder"></div>'), m = t(g)(e);
            o.html(""), o.append(m), e.bufferHeight || (e.bufferHeight = 100), e.preCalc = n.preCalc && "false" !== n.preCalc ? !0 :!1,
            e[d] = [], e.$on("onScroll", function(t, o) {
                ...
                if (t instanceof Array) if (r = t, t.length > 0) {
                    ...
                    console.time("calc"), e.preCalc ? s(r, e.heightCalc, function() {
                        console.timeEnd("calc"), console.time("render"), l(r) && (i(r), a(e, u, e[d], r),
                        e.$digest(), e.$emit("mmRepeat:change"));
            ...
            function o(e) {
                ...
                if (f.canDo("navKeydown")) {
                    if (t.currentUserName) o = n(s, t.currentUserName), c = o, u.wait(function() {
                        ...
                        t.currentUserName = d.UserName, a.setCurrentUserName(d.UserName), t.showChatContentByUserName(d.UserName),
                        r.$digest(), i($(".chat_list.scroll-content")[0], d);
                    }
    ...
    return {
        ...
        link:function(e) {
            e.subscribeMsgs = [], e.articleList = [], e.subscribeMsgs.defaultValue = !0, e.$watch(function() {
                ...
                0 != t && (e.subscribeMsgs = g.getSubscribeMsgs(), e.articleList = m(e.subscribeMsgs),
    ...
    return {
        ...
        link:function(n, r) {
            ...
            r.on("paste", function(n) {
                ...
                n.stopImmediatePropagation()), void (s >= i ? (n.preventDefault(), n.stopImmediatePropagation()) :(a && e.cancel(a),
                a = e(function() {
                    s = 0;
    ...
    return {
        ...
        link:function(t, o) {
            ...
            p.opt.all = p.opt.all || {};
            var h = t.initList || [];
            t.contactList = r(c.pickContacts(p.types, p.opt, !0).result, h), t.selectList = t.selectList || [],
            i(), t.search = function() {
    ...
    function c(t, o) {
        ...
        for (c = 0; c < t.length; c += 16) s = d, l = g, u = m, f = p, d = n(d, g, m, p, t[c], 7, -680876936),
        p = n(p, d, g, m, t[c + 1], 12, -389564586), m = n(m, p, d, g, t[c + 2], 17, 606105819),
        g = n(g, m, p, d, t[c + 3], 22, -1044525330), d = n(d, g, m, p, t[c + 4], 7, -176418897),
        p = n(p, d, g, m, t[c + 5], 12, 1200080426), m = n(m, p, d, g, t[c + 6], 17, -1473231341),
        g = n(g, m, p, d, t[c + 7], 22, -45705983), d = n(d, g, m, p, t[c + 8], 7, 1770035416),
        p = n(p, d, g, m, t[c + 9], 12, -1958414417), m = n(m, p, d, g, t[c + 10], 17, -42063),
        g = n(g, m, p, d, t[c + 11], 22, -1990404162), d = n(d, g, m, p, t[c + 12], 7, 1804603682),
        p = n(p, d, g, m, t[c + 13], 12, -40341101), m = n(m, p, d, g, t[c + 14], 17, -1502002290),
        g = n(g, m, p, d, t[c + 15], 22, 1236535329), d = r(d, g, m, p, t[c + 1], 5, -165796510),
        p = r(p, d, g, m, t[c + 6], 9, -1069501632), m = r(m, p, d, g, t[c + 11], 14, 643717713),
        g = r(g, m, p, d, t[c], 20, -373897302), d = r(d, g, m, p, t[c + 5], 5, -701558691),
        p = r(p, d, g, m, t[c + 10], 9, 38016083), m = r(m, p, d, g, t[c + 15], 14, -660478335),
        g = r(g, m, p, d, t[c + 4], 20, -405537848), d = r(d, g, m, p, t[c + 9], 5, 568446438),
        p = r(p, d, g, m, t[c + 14], 9, -1019803690), m = r(m, p, d, g, t[c + 3], 14, -187363961),
        g = r(g, m, p, d, t[c + 8], 20, 1163531501), d = r(d, g, m, p, t[c + 13], 5, -1444681467),
        p = r(p, d, g, m, t[c + 2], 9, -51403784), m = r(m, p, d, g, t[c + 7], 14, 1735328473),
        g = r(g, m, p, d, t[c + 12], 20, -1926607734), d = a(d, g, m, p, t[c + 5], 4, -378558),
        p = a(p, d, g, m, t[c + 8], 11, -2022574463), m = a(m, p, d, g, t[c + 11], 16, 1839030562),
        g = a(g, m, p, d, t[c + 14], 23, -35309556), d = a(d, g, m, p, t[c + 1], 4, -1530992060),
        p = a(p, d, g, m, t[c + 4], 11, 1272893353), m = a(m, p, d, g, t[c + 7], 16, -155497632),
        g = a(g, m, p, d, t[c + 10], 23, -1094730640), d = a(d, g, m, p, t[c + 13], 4, 681279174),
        p = a(p, d, g, m, t[c], 11, -358537222), m = a(m, p, d, g, t[c + 3], 16, -722521979),
        g = a(g, m, p, d, t[c + 6], 23, 76029189), d = a(d, g, m, p, t[c + 9], 4, -640364487),
        p = a(p, d, g, m, t[c + 12], 11, -421815835), m = a(m, p, d, g, t[c + 15], 16, 530742520),
        g = a(g, m, p, d, t[c + 2], 23, -995338651), d = i(d, g, m, p, t[c], 6, -198630844),
        p = i(p, d, g, m, t[c + 7], 10, 1126891415), m = i(m, p, d, g, t[c + 14], 15, -1416354905),
        g = i(g, m, p, d, t[c + 5], 21, -57434055), d = i(d, g, m, p, t[c + 12], 6, 1700485571),
        p = i(p, d, g, m, t[c + 3], 10, -1894986606), m = i(m, p, d, g, t[c + 10], 15, -1051523),
        g = i(g, m, p, d, t[c + 1], 21, -2054922799), d = i(d, g, m, p, t[c + 8], 6, 1873313359),
        p = i(p, d, g, m, t[c + 15], 10, -30611744), m = i(m, p, d, g, t[c + 6], 15, -1560198380),
        g = i(g, m, p, d, t[c + 13], 21, 1309151649), d = i(d, g, m, p, t[c + 4], 6, -145523070),
        p = i(p, d, g, m, t[c + 11], 10, -1120210379), m = i(m, p, d, g, t[c + 2], 15, 718787259),
        g = i(g, m, p, d, t[c + 9], 21, -343485551), d = e(d, s), g = e(g, l), m = e(m, u),
        p = e(p, f);
        return [ d, g, m, p ];
    }
    function s(e) {
    ...
    angular.module("webwxApp", [ "ui.router", "ngAnimate", "Services", "Controllers", "Directives", "Filters", "ngDialog", "jQueryScrollbar", "ngClipboard", "exceptionOverride" ]).run([ "$rootScope", "$state", "$stateParams", function(e, t, o) {
        ...
        return {
            request:function(t) {
                if (!t.cache && t.url.indexOf(".html") < 0 && (t.params || (t.params = {}), t.params.pass_ticket = e.getPassticket()),
